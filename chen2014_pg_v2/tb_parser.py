...
class State(object):
    ...
    def copy(self):
        copy_s = State(self.data)
        copy_s.n = copy.deepcopy(self.n)
        copy_s.data = copy.deepcopy(self.data)
        copy_s.stack = copy.deepcopy(self.stack)
        copy_s.buffer = copy.deepcopy(self.buffer)
        copy_s.result = self.result.copy()
        return copy_s
