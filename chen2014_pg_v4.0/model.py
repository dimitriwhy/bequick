...
class Classifier(Network):
    def __init__(self, form_size, form_dim, pos_size, pos_dim, deprel_size, deprel_dim, hidden_dim, output_dim,
        ...
        self.grad = tf.train.AdagradOptimizer(learning_rate=0.1).compute_gradients(self.pg_loss)
        self.pg_optimization = tf.train.AdagradOptimizer(learning_rate=0.1).minimize(self.pg_loss)
